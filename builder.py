#!/usr/bin/env python3
"""
Sovereign Enterprise System - Rate-Limited Meta-Builder
File: builder.py
Purpose: Reads a structural system JSON blueprint and systematically compiles
         ...
         Includes rate-limiting fallbacks to bypass Free Tier API limits.
"""
...
def run_meta_builder():
    ...
    api_key = "AIzaSy..."  # <--- RE-PASTE YOUR COPIED GEMINI API KEY ENTIRELY HERE
    
    if not api_key or api_key == "AIzaSy...":
        print("[-] Error: Please paste your active Gemini API key directly onto line 44 of builder.py.")
        sys.exit(1)
    ...
    for module_idx, module in enumerate(modules, start=1):
        ...
        for file_info in files:
            ...
            try:
                # Swapped to gemini-2.5-flash to take advantage of the massive free-tier request limits
                ...
                # Hard 6-second cooldown loop. This spaces requests perfectly to keep you
                # completely under the token-per-minute ceiling on the free plan.
                print("        [*] Enforcing 6-second API cool-down pause...")
                time.sleep(6)
