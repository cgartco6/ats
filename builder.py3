...
def run_meta_builder():
    # 1. Initialize client using the google-genai SDK standard layout
    ...
    # Fallback to apex_blueprint.json if your current file uses that name
    if not os.path.exists(blueprint_file) and os.path.exists("apex_blueprint.json"):
